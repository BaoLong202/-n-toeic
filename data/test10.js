...
window.TOEIC_EXPLANATIONS[10] = {
  101: "💡 <b>Đáp án (A) her:</b> Cần tính từ sở hữu 'her' đứng trước danh từ 'work' (khen ngợi công việc của cô ấy đối với tài khoản khách hàng Kala)[cite: 22].",
  102: "💡 <b>Đáp án (D) performed:</b> Động từ ở quá khứ đơn 'performed' (đã biểu diễn trên sân khấu hòa nhạc chính)[cite: 22].",
  103: "💡 <b>Đáp án (B) additional:</b> Tính từ 'additional' (bổ sung, thêm vào) bổ nghĩa cho cụm danh từ 'cases of ink toner'[cite: 22].",
  104: "💡 <b>Đáp án (A) better:</b> Trạng từ so sánh hơn 'better' trong cụm 'help understand better' (giúp hiểu rõ hơn về các dịch vụ tài chính)[cite: 22].",
  105: "💡 <b>Đáp án (D) Production:</b> Danh từ không đếm được 'Production' (Sự sản xuất hàng may mặc) làm chủ ngữ cho câu[cite: 22].",
  106: "💡 <b>Đáp án (B) minor:</b> Cụm danh từ 'minor errors' (những lỗi nhỏ, không đáng kể)[cite: 22].",
  107: "💡 <b>Đáp án (A) when:</b> Liên từ chỉ thời gian 'when' (yêu cầu tắt chuông điện thoại khi buổi biểu diễn bắt đầu)[cite: 22].",
  108: "💡 <b>Đáp án (B) by:</b> Giới từ chỉ phương tiện đi lại 'commute to work by train' (đi làm bằng tàu hỏa)[cite: 22].",
  109: "💡 <b>Đáp án (D) continuously:</b> Trạng từ 'continuously' (liên tục) bổ nghĩa cho phân từ 'operating'[cite: 22].",
  110: "💡 <b>Đáp án (B) reminder:</b> Danh từ 'reminder' trong cấu trúc 'This message is a reminder to...' (Thông báo này là một lời nhắc nhở)[cite: 22].",
  111: "💡 <b>Đáp án (B) who:</b> Đại từ quan hệ 'who' thay thế cho danh từ chỉ người 'Pet Orbit customers' làm chủ ngữ[cite: 22].",
  112: "💡 <b>Đáp án (A) but:</b> Liên từ tương phản 'but' (Mặc dù là nhân viên mới vào nghề, nhưng anh ấy không ngần ngại chủ động)[cite: 22].",
  113: "💡 <b>Đáp án (B) to place:</b> Cấu trúc 'allow somebody to do something' (cho phép khách hàng giữ hàng tối đa 24 giờ)[cite: 22].",
  114: "💡 <b>Đáp án (D) fashionable:</b> Tính từ 'fashionable' (hợp thời trang, phong cách) bổ nghĩa cho danh từ 'look'[cite: 22].",
  115: "💡 <b>Đáp án (C) Because of:</b> Cụm giới từ chỉ nguyên nhân 'Because of' đi với cụm danh từ 'efficient project management'[cite: 22].",
  116: "💡 <b>Đáp án (B) at:</b> Giới từ 'at' đi với địa điểm cụ thể 'at select stores' (tại các cửa hàng được lựa chọn)[cite: 22].",
  117: "💡 <b>Đáp án (C) noticeable:</b> Tính từ 'noticeable' (đáng chú ý, rõ rệt) đứng trước danh từ 'decrease'[cite: 22].",
  118: "💡 <b>Đáp án (A) so:</b> Liên từ chỉ kết quả 'so' (Bina Dal luôn muốn làm nhà ngoại giao, vì vậy cô ấy đã học quan hệ quốc tế)[cite: 22].",
  119: "💡 <b>Đáp án (B) promptly:</b> Trạng từ 'promptly' (một cách nhanh chóng, kịp thời) bổ nghĩa cho động từ 'responding'[cite: 22].",
  120: "💡 <b>Đáp án (A) reschedule:</b> Động từ nguyên thể 'reschedule' (sắp xếp lại/dời lịch hẹn chặt cây do thời tiết)[cite: 22].",
  121: "💡 <b>Đáp án (C) coordinated:</b> Tính từ 'coordinated effort' (nỗ lực phối hợp nhịp nhàng giữa hai quốc gia)[cite: 22].",
  122: "💡 <b>Đáp án (D) policy:</b> Cụm danh từ 'restaurant's policy' (chính sách/quy định của nhà hàng)[cite: 22].",
  123: "💡 <b>Đáp án (B) had anticipated:</b> Hành động ban tổ chức dự tính xảy ra trước việc bán hết vé trong quá khứ -> chia quá khứ hoàn thành[cite: 22].",
  124: "💡 <b>Đáp án (D) rather than:</b> Cụm từ mang nghĩa 'thay vì' (Làm thủ tục gia hạn trực tuyến thay vì tới văn phòng)[cite: 22].",
  125: "💡 <b>Đáp án (A) Given:</b> Giới từ 'Given' mang nghĩa 'Xét đến / Căn cứ vào danh tiếng vững chắc của công ty'[cite: 22].",
  126: "💡 <b>Đáp án (A) so that:</b> Liên từ chỉ mục đích 'so that' (để danh bạ nhân viên có thể được hoàn tất)[cite: 22].",
  127: "💡 <b>Đáp án (D) imitations:</b> Danh từ số nhiều 'inferior imitations' (những sản phẩm làm nhái kém chất lượng)[cite: 22].",
  128: "💡 <b>Đáp án (D) Despite:</b> Giới từ chỉ sự nhượng bộ 'Despite the fact that' (Mặc dù thực tế là...)[cite: 22].",
  129: "💡 <b>Đáp án (C) convincing:</b> Tính từ 'convincing arguments' (những lập luận thuyết phục)[cite: 22].",
  130: "💡 <b>Đáp án (B) named:</b> Cụm bị động 'was named Director' (được bổ nhiệm làm Giám đốc chương trình)[cite: 22].",
  131: "💡 <b>Đáp án (D) containers:</b> Danh từ 'containers' thay thế đồng nghĩa cho các thùng chứa 'crates' ở câu trước[cite: 22].",
  132: "💡 <b>Đáp án (C):</b> 'Accordingly, more of them can be loaded onto trucks when empty' giải thích thùng gập lại tiết kiệm diện tích trên xe[cite: 22].",
  133: "💡 <b>Đáp án (B) for:</b> Danh từ 'need' đi với giới từ 'for' (the need for frequent replacement - nhu cầu thay thế thường xuyên)[cite: 22].",
  134: "💡 <b>Đáp án (A) reducing:</b> Rút gọn mệnh đề phân từ hiện tại chỉ kết quả 'thereby reducing the risk of injuries'[cite: 22].",
  135: "💡 <b>Đáp án (D) is based:</b> Thể bị động thì hiện tại đơn 'is based on the book' (được dựa trên cuốn tiểu thuyết)[cite: 22].",
  136: "💡 <b>Đáp án (B) In contrast:</b> Cụm liên từ nối tương phản 'In contrast, other reviewers argue...' (Trái lại, các nhà phê bình khác lại cho rằng...)[cite: 22].",
  137: "💡 <b>Đáp án (C) criticism:</b> Danh từ 'criticism' (lời chỉ trích/phê bình về việc đưa vào quá nhiều nhân vật mới)[cite: 22].",
  138: "💡 <b>Đáp án (B):</b> Đạo diễn phản biện 'But they bring greater depth to the narrative' (Nhưng các nhân vật mang lại chiều sâu cho cốt truyện)[cite: 22].",
  139: "💡 <b>Đáp án (C) sharing:</b> Sau giới từ 'for' cần danh động từ V-ing 'sharing your interesting recipe'[cite: 22].",
  140: "💡 <b>Đáp án (A) It:</b> Đại từ 'It' thay thế cho công thức nấu ăn gửi dự thi ở câu trước[cite: 22].",
  141: "💡 <b>Đáp án (B):</b> 'Contest winners will be notified in June' bổ sung thông tin thời điểm công bố người trúng giải cuộc thi[cite: 22].",
  142: "💡 <b>Đáp án (D) shortly:</b> Trạng từ 'shortly' (ngay sau đây / sớm thôi) chỉ thời gian gửi email chứa mã giảm giá[cite: 22].",
  143: "💡 <b>Đáp án (B) However:</b> Trạng từ tương phản (Tuy nhiên, một số khách hàng lại thích gửi bản phác thảo rất chi tiết)[cite: 22].",
  144: "💡 <b>Đáp án (C) perfection:</b> Cấu trúc song song danh từ 'development, creation, and perfection' (hoàn thiện bản vẽ)[cite: 22].",
  145: "💡 <b>Đáp án (B):</b> 'This step ensures that the product satisfies expectations' giải thích bước gửi bản mẫu cho khách duyệt[cite: 22].",
  146: "💡 <b>Đáp án (D) on:</b> Cụm động từ 'count on' (tin cậy vào công ty Bingo Imprint)[cite: 22].",
  147: "💡 <b>Đáp án (D):</b> Bảng khảo sát đánh giá phòng khách, bếp, phòng ngủ -> Công ty dọn dẹp nhà ở gia đình (A home)[cite: 22].",
  148: "💡 <b>Đáp án (B):</b> Câu hỏi 'Was it easy to make an appointment?' nhận mức điểm thấp nhất 1 sao -> Không hài lòng về khâu đặt lịch (The scheduling)[cite: 22].",
  149: "💡 <b>Đáp án (B):</b> Dịch vụ giao hàng 'large- and small-volume deliveries' -> Nhận giao các đơn hàng với nhiều khối lượng/kích cỡ khác nhau[cite: 22].",
  150: "💡 <b>Đáp án (D):</b> Khách hàng bị phạt $50 nếu lái xe không thể tiếp cận được vị trí đổ hàng ('not accessible for our trucks')[cite: 22].",
  151: "💡 <b>Đáp án (A):</b> Frank Gerlin bận làm báo cáo hiệu suất cá nhân và xin 45 phút ngụ ý anh ấy sẵn sàng giúp đỡ sau đó[cite: 22].",
  152: "💡 <b>Đáp án (D):</b> Hannah trả lời 'I'll double-check the cost data in the meantime' -> Cô ấy sẽ rà soát lại số liệu chi phí báo cáo[cite: 22].",
  153: "💡 <b>Đáp án (B):</b> Email thông báo cảnh báo giảm giá vé máy bay ('price cuts on your preferred trips') cho hành trình đã đăng ký[cite: 22].",
  154: "💡 <b>Đáp án (C):</b> Cả hai chuyến đi đều đưa ra lựa chọn của hai hãng hàng không giống nhau: Nomata Airlines và Blue Range Airways[cite: 22].",
  155: "💡 <b>Đáp án (A):</b> Tác giả nhờ người nhận rà soát các công thức nấu ăn để đảm bảo chúng dễ làm theo (Make sure her recipes are clear)[cite: 22].",
  156: "💡 <b>Đáp án (C):</b> Các ô đánh dấu X đỏ là lời nhắc nhở để chụp lại ảnh các bước cho đẹp hơn rồi chèn vào sau (Images that need to be replaced)[cite: 22].",
  157: "💡 <b>Đáp án (C):</b> Vị trí [3] theo sau yêu cầu ghi chú ý kiến vào lề văn bản 'Otherwise it is hard to keep track of all the changes'[cite: 22].",
  158: "💡 <b>Đáp án (C):</b> Bức thư nêu rõ: 'offering your customers across Europe unique and delicious menu items' -> Vận hành chuỗi nhà hàng ở nhiều nơi tại châu Âu[cite: 22].",
  159: "💡 <b>Đáp án (B):</b> Từ 'solid' trong cụm 'solid reputation' (danh tiếng vững chắc, uy tín) đồng nghĩa với **reliable**[cite: 22].",
  160: "💡 <b>Đáp án (D):</b> Bức thư nhắc đến quảng cáo, khách hàng mới, giảm giá nguyên liệu nhưng KHÔNG nhắc đến chương trình đào tạo chất lượng[cite: 22].",
  161: "💡 <b>Đáp án (B):</b> Bài báo đưa tin Trung tâm Y tế Karinya nhận giải thưởng danh giá Stellar Service Merit nhằm ngợi khen tổ chức này[cite: 22].",
  162: "💡 <b>Đáp án (D):</b> Bài viết chỉ nêu bệnh viện đạt giải thưởng của quỹ Valorcare chứ KHÔNG nói bệnh viện từng nhận được nhiều giải thưởng qua các năm[cite: 22].",
  163: "💡 <b>Đáp án (A):</b> Từ 'reflects' (phản ánh, chứng minh) đồng nghĩa với **shows**[cite: 22].",
  164: "💡 <b>Đáp án (C):</b> Maxwell nhắc nhở nội quy 'the rule for Pool Guardian lifeguards is...' -> Alexa là nhân viên của công ty Pool Guardian[cite: 22].",
  165: "💡 <b>Đáp án (D):</b> Alexa xin đóng bể bơi sớm vì từ 2h30 đến giờ không có khách nào đến bơi cả[cite: 22].",
  166: "💡 <b>Đáp án (A):</b> Wade Nolan nói: 'Our contract says we must supply Rosemoor Park with a lifeguard until 5 P.M.' -> Công viên có hợp đồng thuê cứu hộ với công ty[cite: 22].",
  167: "💡 <b>Đáp án (B):</b> Alexa vừa thu dọn kho chứa thiết bị bể bơi nên câu 'It has never looked so good' ngụ ý kho chứa đồ đã được dọn rất ngăn nắp, sạch sẽ[cite: 22].",
  168: "💡 <b>Đáp án (A):</b> Sagemont Services cung cấp các giải pháp công nghệ thông tin theo yêu cầu -> Công ty tư vấn giải pháp công nghệ[cite: 22].",
  169: "💡 <b>Đáp án (D):</b> Trang web nêu thành tích: 'helped several businesses complete technology projects on tight deadlines in the past few months'[cite: 22].",
  170: "💡 <b>Đáp án (B):</b> Doanh nghiệp bán lẻ trực tuyến Clothing Discounters được miêu tả là 'rapidly expanding' (đang mở rộng quy mô rất nhanh)[cite: 22].",
  171: "💡 <b>Đáp án (C):</b> Vị trí [3] theo sau giải pháp thiết lập tổng đài làm việc tại nhà trong 2 ngày 'This solution eliminated the possibility of business disruption'[cite: 22].",
  172: "💡 <b>Đáp án (C):</b> Nhà điêu khắc Ida Alonso nảy ra ý tưởng sau khi đọc bài báo về ghế công viên làm từ nhựa tái chế trên tạp chí cảnh quan[cite: 22].",
  173: "💡 <b>Đáp án (B):</b> Khách đến xem triển lãm có thể mang theo rác thải nhựa tái chế của mình bỏ vào các túi thu gom lớn trong phòng trưng bày[cite: 22].",
  174: "💡 <b>Đáp án (A):</b> Vào ngày cuối (4/11), toàn bộ tác phẩm sẽ tháo dỡ và vật liệu tái chế được chuyển tới nhà máy Flyner Industries để làm rèm chống thấm[cite: 22].",
  175: "💡 <b>Đáp án (C):</b> Câu cuối bài báo nêu rõ các tác phẩm của sinh viên mỹ thuật địa phương sẽ được trưng bày tại phòng triển lãm chính của MCAC[cite: 22].",
  176: "💡 <b>Đáp án (B):</b> Bảng khảo sát cho thấy mức độ hài lòng về 'Overall experience' tháng 6 là 87%, tăng 7% so với tháng 5 (+7%)[cite: 22].",
  177: "💡 <b>Đáp án (A):</b> Bảng ghi 'Collected and analysed by Naomi Akdemir... Exelrate' -> Exelrate vừa thu thập vừa phân tích dữ liệu[cite: 22].",
  178: "💡 <b>Đáp án (B):</b> Từ 'directing' trong cụm 'directing this expansion' (chỉ đạo đợt mở rộng) đồng nghĩa với **leading**[cite: 22].",
  179: "💡 <b>Đáp án (C):</b> Bà Rosa Martin quản lý nhóm Giải pháp khách hàng tại trụ sở chính ở Frankfurt cho đến hết tháng 7 -> Bà ấy làm việc tại Frankfurt[cite: 22].",
  180: "💡 <b>Đáp án (C):</b> Frank Tsudama là người thiết kế tòa nhà mới của Exelrate và trung tâm thương mại Seoul Global Trade Centre -> Làm trong ngành kiến trúc[cite: 22].",
  181: "💡 <b>Đáp án (B):</b> Lớp học nấu ăn tổ chức tại bếp siêu thị với các nguyên liệu có thể mua trực tiếp tại các kệ hàng -> Hướng tới khách mua sắm của siêu thị[cite: 22].",
  182: "💡 <b>Đáp án (A):</b> Thực đơn các tuần tháng 8 giới thiệu món ăn từ Ấn Độ, Thái Lan, Mexico, Ý -> Món ăn từ các quốc gia khác nhau[cite: 22].",
  183: "💡 <b>Đáp án (C):</b> Astrid Klein cho biết tuần trước cô đã tham gia lớp làm bánh taco cá ('fish tacos'), tra lịch là lớp ngày 16 tháng 8[cite: 22].",
  184: "💡 <b>Đáp án (D):</b> Bài đánh giá kể các thành phần gồm vỏ bánh ngô, cá rô phi, sốt cà chua xanh nhưng KHÔNG nhắc đến bắp cải bào (Shredded cabbage)[cite: 22].",
  185: "💡 <b>Đáp án (C):</b> Người đánh giá khẳng định sẽ dành trống các tối thứ Hai để tiếp tục tham gia nhiều lớp học nấu ăn nữa[cite: 22].",
  186: "💡 <b>Đáp án (A):</b> Bác sĩ Jennifer Robbins vừa được bổ nhiệm làm Hiệu trưởng/Viện trưởng mới của Viện Mắt Callard[cite: 22].",
  187: "💡 <b>Đáp án (C):</b> Bài báo nêu rõ bà Robbins đã hoàn thành khóa đào tạo nội trú sau tiến sĩ tại Trung tâm Y tế Petersen[cite: 22].",
  188: "💡 <b>Đáp án (D):</b> Lịch trình ngày 17/4 ghi lễ trao giải diễn ra lúc 9h tối tại khán phòng Regal Ballroom, do đó đây là nơi bà nhận huy chương Kramer[cite: 22].",
  189: "💡 <b>Đáp án (D):</b> Chủ tịch Paulina Raskin gửi thư để bày tỏ sự cảm kích về bài phát biểu khai mạc xuất sắc của Bác sĩ Sohn tại hội nghị ICVA[cite: 22].",
  190: "💡 <b>Đáp án (B):</b> Bác sĩ Sohn đọc diễn văn chào mừng và phát biểu chủ đề ('Welcome and keynote address'), tra lịch trình là từ 10:00 đến 11:00 sáng[cite: 22].",
  191: "💡 <b>Đáp án (B):</b> Thợ kỹ thuật sẽ kiểm tra tình trạng xe đạp của khách khi khách mang tới theo lịch hẹn[cite: 22].",
  192: "💡 <b>Đáp án (B):</b> Nicola Johnson viết trong email ngày 2/11: 'I have a mountain bicycle that is now six years old' -> Cô có chiếc xe từ 6 năm trước[cite: 22].",
  193: "💡 <b>Đáp án (C):</b> Nicola muốn ký gửi xe để bán, và trang web nêu dịch vụ ký gửi sẽ giữ lại phí 15% khi bán được -> Chấp nhận mức phí dịch vụ này[cite: 22].",
  194: "💡 <b>Đáp án (D):</b> Email nhắc lại quy định của công ty: tiền bán xe bắt buộc phải chuyển khoản qua ngân hàng và không cam kết bán được trước hạn khách đòi[cite: 22].",
  195: "💡 <b>Đáp án (A):</b> Trang web nêu người gửi email đặt hẹn sẽ nhận phản hồi từ Quản lý chăm sóc khách hàng (customer service manager), do đó Peter Moran giữ chức vụ này[cite: 22].",
  196: "💡 <b>Đáp án (B):</b> Quản lý nhân sự Simon Cady gửi email yêu cầu cô Kuroda nộp bổ sung các giấy tờ cá nhân còn thiếu theo danh sách[cite: 22].",
  197: "💡 <b>Đáp án (A):</b> Email nhắc: 'At the training for new hires this morning...' -> Buổi sáng cô Kuroda đã tham gia buổi đào tạo nhân viên mới[cite: 22].",
  198: "💡 <b>Đáp án (B):</b> Simon Cady giải thích mục số 6 (giấy miễn trừ trách nhiệm) chỉ cần nộp nếu cô tham gia đội bóng mềm (softball team) của công ty[cite: 22].",
  199: "💡 <b>Đáp án (C):</b> Cô Kuroda hào hứng: 'look forward to the opportunity to get to know my coworkers better' -> Rất mong muốn được giao lưu với đồng nghiệp tại buổi dã ngoại[cite: 22].",
  200: "💡 <b>Đáp án (B):</b> Cô Kuroda viết: 'I am about to gather the necessary information for the fourth item on the list' (Mục số 4 là thông tin tài khoản ngân hàng) -> Đi tìm chi tiết tài khoản ngân hàng của mình[cite: 22]."
};
