...
window.TOEIC_EXPLANATIONS[9] = {
  101: "💡 <b>Đáp án (A) records:</b> Sau tính từ sở hữu 'Our' cần danh từ số nhiều 'records' (dữ liệu/hồ sơ lưu trữ) làm chủ ngữ[cite: 21].",
  102: "💡 <b>Đáp án (B) main:</b> Cụm danh từ 'main entrance' (lối vào chính của tòa nhà)[cite: 21].",
  103: "💡 <b>Đáp án (B) carefully:</b> Trạng từ 'carefully' (một cách cẩn thận) bổ nghĩa cho cặp động từ bị động 'handled and stored'[cite: 21].",
  104: "💡 <b>Đáp án (C) allows:</b> Cấu trúc 'allow somebody/something to V' (cho phép các đoàn tàu chuyển đổi nhanh chế độ)[cite: 21].",
  105: "💡 <b>Đáp án (A) stores:</b> Sau tính từ 'new' và số lượng 28 cần danh từ đếm được số nhiều 'stores' (cửa hàng mới)[cite: 21].",
  106: "💡 <b>Đáp án (A) seeking:</b> Động từ 'seeking' trong cụm 'seeking new tenants' (tìm kiếm khách thuê mặt bằng bán lẻ mới)[cite: 21].",
  107: "💡 <b>Đáp án (C) her:</b> Tính từ sở hữu 'her' đứng trước cụm danh từ 'distinctive style' (phong cách độc đáo của cô ấy)[cite: 21].",
  108: "💡 <b>Đáp án (A) around:</b> Giới từ 'around 4:00 P.M.' chỉ mốc thời gian ước lượng khoảng 4 giờ chiều[cite: 21].",
  109: "💡 <b>Đáp án (B) celebrated:</b> Dấu hiệu thời gian quá khứ 'Last Monday' -> chia động từ ở quá khứ đơn 'celebrated'[cite: 21].",
  110: "💡 <b>Đáp án (D) proposal:</b> Danh từ 'proposal' (bản đề xuất giảm tiêu thụ năng lượng của cô Xuan)[cite: 21].",
  111: "💡 <b>Đáp án (C) enthusiastically:</b> Trạng từ 'enthusiastically' (một cách hào hứng) bổ nghĩa cho động từ 'accepted'[cite: 21].",
  112: "💡 <b>Đáp án (A) opposite:</b> Giới từ 'opposite' (nằm đối diện với quán ăn Verdigris Bistro)[cite: 21].",
  113: "💡 <b>Đáp án (C) to become:</b> Cấu trúc 'promise to do something' (hứa sẽ trở thành người cố vấn)[cite: 21].",
  114: "💡 <b>Đáp án (B) widely:</b> Cụm trạng từ 'widely available' (được phân phối và bày bán rộng rãi)[cite: 21].",
  115: "💡 <b>Đáp án (D) partnerships:</b> Cụm thành ngữ 'formed partnerships with' (thiết lập mối quan hệ đối tác với các doanh nghiệp)[cite: 21].",
  116: "💡 <b>Đáp án (A) knowledge:</b> Cụm từ 'limited knowledge of a product' (sự hiểu biết hạn chế về sản phẩm)[cite: 21].",
  117: "💡 <b>Đáp án (C) Something:</b> Đại từ bất định 'Something' (Có điều gì đó đang ngăn cản các nghệ sĩ tiếp cận tệp ảnh)[cite: 21].",
  118: "💡 <b>Đáp án (B) Despite:</b> Giới từ chỉ sự nhượng bộ 'Despite a delay' (Mặc dù có sự chậm trễ...)[cite: 21].",
  119: "💡 <b>Đáp án (D) effectively:</b> Trạng từ 'effectively closed' (trên thực tế coi như đã đóng cửa kinh doanh)[cite: 21].",
  120: "💡 <b>Đáp án (D) over:</b> Giới từ chỉ khoảng thời gian 'over the last two years' (trong suốt 2 năm qua)[cite: 21].",
  121: "💡 <b>Đáp án (D) may submit:</b> Động từ khuyết thiếu 'may submit' (các tổ chức phi lợi nhuận có thể nộp tối đa 3 bộ hồ sơ)[cite: 21].",
  122: "💡 <b>Đáp án (B) favorably:</b> Trạng từ 'favorably' (một cách tích cực, ưu ái) bổ nghĩa cho phản ứng khen ngợi của giới phê bình[cite: 21].",
  123: "💡 <b>Đáp án (C) among:</b> Giới từ 'among' (nổi tiếng trong giới nhà văn và nhà xuất bản)[cite: 21].",
  124: "💡 <b>Đáp án (C) soar:</b> Động từ nguyên thể 'soar' (khiến giá đồ gỗ tăng vọt)[cite: 21].",
  125: "💡 <b>Đáp án (A) magnetic:</b> Tính từ 'magnetic tray' (khay từ tính/nam châm gắn vào bề mặt kim loại)[cite: 21].",
  126: "💡 <b>Đáp án (B) neglected:</b> Cấu trúc 'neglect to do something' (bỏ sót/quên không mua bảo hành mở rộng)[cite: 21].",
  127: "💡 <b>Đáp án (B) engaged:</b> Tính từ 'engaged' (chăm chú, bị cuốn hút) sau động từ nối 'remain'[cite: 21].",
  128: "💡 <b>Đáp án (B) In addition to:</b> Cụm giới từ 'In addition to' (Bên cạnh hoa quả và rau tươi...)[cite: 21].",
  129: "💡 <b>Đáp án (D) Whichever:</b> Từ hạn định 'Whichever route they choose' (Bất kể lộ trình nào họ lựa chọn)[cite: 21].",
  130: "💡 <b>Đáp án (A) rigorous:</b> Tính từ 'rigorous inspections' (các cuộc kiểm tra nghiêm ngặt không có lỗi)[cite: 21].",
  131: "💡 <b>Đáp án (B) wood:</b> Sản phẩm đồ gỗ sồi ở câu sau làm rõ vẻ đẹp của chất liệu gỗ tự nhiên 'natural wood'[cite: 21].",
  132: "💡 <b>Đáp án (D):</b> 'They are what makes each piece unique' giải thích các mắt gỗ nhỏ chính là điều tạo nên sự độc đáo[cite: 21].",
  133: "💡 <b>Đáp án (A) Moreover:</b> Trạng từ liên kết bổ sung 'Hơn nữa, thiết kế treo tường còn giải phóng diện tích sàn'[cite: 21].",
  134: "💡 <b>Đáp án (C) retailers:</b> Cụm danh từ 'furniture retailers' (các nhà bán lẻ đồ nội thất)[cite: 21].",
  135: "💡 <b>Đáp án (D) components:</b> Danh từ 'components' (đảm bảo tất cả các linh kiện/bộ phận của nồi cơm điện nguội hẳn)[cite: 21].",
  136: "💡 <b>Đáp án (B) can be:</b> Thể bị động diễn tả khả năng 'can be damaged by abrasive cleaners' (có thể bị trầy hại bởi chất tẩy mạnh)[cite: 21].",
  137: "💡 <b>Đáp án (A):</b> 'Then, use a soft brush or sponge to finish cleaning' tiếp nối bước ngâm nồi trong nước xà phòng ấm[cite: 21].",
  138: "💡 <b>Đáp án (B) Instead:</b> Trạng từ nối 'Thay vào đó, chỉ cần lau nhẹ nhàng bên ngoài bằng khăn ẩm'[cite: 21].",
  139: "💡 <b>Đáp án (C) extensive:</b> Tính từ 'extensive notes' (ghi chép rất chi tiết, cặn kẽ trong buổi họp)[cite: 21].",
  140: "💡 <b>Đáp án (D) Each:</b> Đại từ 'Each' (Mỗi bản phác thảo) làm chủ ngữ đại diện cho từng mẫu thiết kế[cite: 21].",
  141: "💡 <b>Đáp án (A):</b> 'Nonetheless, they all give an impression of trustworthiness and precision' kết nối hai nhóm phong cách logo cổ điển và tối giản[cite: 21].",
  142: "💡 <b>Đáp án (D) finalizing:</b> Sau cụm 'look forward to' cần danh động từ V-ing 'finalizing the design' (hoàn thiện mẫu thiết kế)[cite: 21].",
  143: "💡 <b>Đáp án (D) undisclosed:</b> Cụm từ 'an undisclosed amount' (một khoản tiền không được tiết lộ ra ngoài)[cite: 21].",
  144: "💡 <b>Đáp án (C) purchase:</b> Danh từ 'purchase' (thương vụ mua lại công ty) thay thế cho từ acquisition ở câu trước[cite: 21].",
  145: "💡 <b>Đáp án (A):</b> 'The fate of the shop in Leeds is still unknown' bổ sung thông tin cho việc 5 trong 6 cửa hàng được mua lại[cite: 21].",
  146: "💡 <b>Đáp án (A) will be adding:</b> Thì tương lai tiếp diễn diễn tả giá trị mà thương hiệu Shipley sẽ đóng góp vào danh mục sản phẩm[cite: 21].",
  147: "💡 <b>Đáp án (D):</b> Mục đích sự kiện để đón chào và giới thiệu Giám đốc tài chính mới (Ms. Misun Lee)[cite: 21].",
  148: "💡 <b>Đáp án (A):</b> Sự kiện có phục vụ cà phê và bánh ngọt ('pastries and coffee') cho đồng nghiệp[cite: 21].",
  149: "💡 <b>Đáp án (D):</b> Tài khoản tự động đóng sau 6 tháng không hoạt động và tài khoản của ông Hong sắp bị vô hiệu hóa vì không đăng nhập gần đây[cite: 21].",
  150: "💡 <b>Đáp án (B):</b> Để giữ quyền truy cập tài khoản, ông Hong chỉ cần đăng nhập trước ngày 20 tháng 7 ('sign in to the app before that date')[cite: 21].",
  151: "💡 <b>Đáp án (C):</b> Khách hàng liên hệ để xác nhận thợ kỹ thuật sửa lò sưởi đã đến chưa vì ông đã xin nghỉ làm để đón thợ[cite: 21].",
  152: "💡 <b>Đáp án (D):</b> Ông Dakers cần đến văn phòng sớm nên lịch hẹn vào buổi chiều (3:00 - 5:00 P.M.) là hoàn toàn không phù hợp với ông[cite: 21].",
  153: "💡 <b>Đáp án (B):</b> Từ 'ordinarily' (thông thường) đồng nghĩa với **typically**[cite: 21].",
  154: "💡 <b>Đáp án (D):</b> Bản ghi nhớ nhắc đến uy tín chất lượng dịch vụ hàng đầu của công ty được khách hàng đánh giá cao[cite: 21].",
  155: "💡 <b>Đáp án (A):</b> Hạn chót gửi đơn đăng ký nghỉ phép mùa hè là thứ Sáu, ngày 28 tháng 4 ('Friday, April 28')[cite: 21].",
  156: "💡 <b>Đáp án (B):</b> Mẫu điện thoại Cirro có thêm bút cảm ứng điện tử để viết vẽ trên màn hình ('electronic stylus')[cite: 21].",
  157: "💡 <b>Đáp án (B):</b> Bài báo nêu cải tiến lớn và ấn tượng nhất nằm ở máy ảnh/camera của điện thoại[cite: 21].",
  158: "💡 <b>Đáp án (D):</b> Khách hàng hiện có thể đặt trước sản phẩm tại cửa hàng trực tuyến của hãng ('online shop')[cite: 21].",
  159: "💡 <b>Đáp án (C):</b> Dự án phim tài liệu kể câu chuyện thị trấn Tottenton chuyển mình thành trung tâm kiến trúc bền vững[cite: 21].",
  160: "💡 <b>Đáp án (B):</b> Đạo diễn tìm cư dân từ 50 tuổi trở lên để phỏng vấn chia sẻ ký ức trong giai đoạn chuyển mình này[cite: 21].",
  161: "💡 <b>Đáp án (A):</b> Hướng dẫn viết bài giới thiệu bản thân nhằm thể hiện phẩm chất vượt trội với nhà tuyển dụng -> Dành cho người xin việc[cite: 21].",
  162: "💡 <b>Đáp án (C):</b> Bài viết hướng dẫn về dung lượng từ, chất lượng hành văn, vượt qua thử thách nhưng KHÔNG đề cập đến chi tiết bằng cấp học vấn[cite: 21].",
  163: "💡 <b>Đáp án (D):</b> Đoạn cuối nên điều chỉnh linh hoạt riêng biệt cho từng vị trí nộp đơn ('easily customizable')[cite: 21].",
  164: "💡 <b>Đáp án (C):</b> Vị trí [3] theo sau câu nói về sự hợp tác và học hỏi từ người khác 'You might explain, for instance, how a person you respect...'[cite: 21].",
  165: "💡 <b>Đáp án (B):</b> Đoạn chat xoay quanh công tác khảo sát thực địa và cập nhật tình trạng bảo dưỡng cầu Crosley[cite: 21].",
  166: "💡 <b>Đáp án (C):</b> Ji-Min Jeon nhắn lúc 8:04: 'I am on-site at the Crosley Bridge now'[cite: 21].",
  167: "💡 <b>Đáp án (D):</b> Karl Scholz là người giao nhiệm vụ và điều phối lịch trình khảo sát của Ji-Min Jeon -> Người chỉ đạo công việc[cite: 21].",
  168: "💡 <b>Đáp án (C):</b> Ji-Min Jeon hứa sẽ có mặt lúc 12:30 để kịp ăn trưa và giải đáp thắc mắc chuyên môn cho Ana Vega[cite: 21].",
  169: "💡 <b>Đáp án (A):</b> Mục đích email là mời ông Fukiyama tham gia ban tuyển chọn nhân sự cấp cao dưới danh nghĩa tư vấn viên bên ngoài[cite: 21].",
  170: "💡 <b>Đáp án (B):</b> Ông Fukiyama từng giữ chức Giám đốc cấp cao về thiết kế đồ họa trước khi nghỉ hưu 4 năm trước[cite: 21].",
  171: "💡 <b>Đáp án (C):</b> Sau khi ký cam kết bảo mật, bà Acro sẽ gửi hồ sơ và sơ yếu lý lịch (résumés) của các ứng viên[cite: 21].",
  172: "💡 <b>Đáp án (A):</b> Dự án nâng cấp hoàn thành và mở cửa sớm hơn 1 tuần so với kế hoạch ban đầu[cite: 21].",
  173: "💡 <b>Đáp án (B):</b> Giám đốc Ann Wert chia sẻ: 'Every week in the museum lobby, I interview patrons and record their opinions' (gặp gỡ và phỏng vấn trực tiếp khách tham quan)[cite: 21].",
  174: "💡 <b>Đáp án (C):</b> Giám đốc khuyên khách tham quan nên đi dạo ngắm khu phố di sản lịch sử lân cận sau khi rời bảo tàng[cite: 21].",
  175: "💡 <b>Đáp án (D):</b> Vị trí [4] giải thích việc khách tự điều khiển trải nghiệm qua màn hình cảm ứng để chọn học chủ đề mình quan tâm[cite: 21].",
  176: "💡 <b>Đáp án (D):</b> Gian hàng 101 bán đĩa salad, dụng cụ phục vụ; gian hàng 103 bán bát sành, đĩa, bình nước -> Đều bán đồ dùng nhà bếp[cite: 21].",
  177: "💡 <b>Đáp án (D):</b> Gian hàng xà phòng Franny's Sensational Scents sử dụng thảo mộc và hoa thu hoạch từ chính khu vườn của họ ('parts of plants')[cite: 21].",
  178: "💡 <b>Đáp án (A):</b> Khách hàng liên hệ nhờ sửa mặt dây chuyền bị gãy theo như lời hứa hỗ trợ trước đó của người bán[cite: 21].",
  179: "💡 <b>Đáp án (B):</b> Mặt dây chuyền làm từ trang sách gấp nghệ thuật tương ứng sản phẩm của Folding Designs tại gian hàng 102[cite: 21].",
  180: "💡 <b>Đáp án (C):</b> Kelly McFarlan làm việc trên cùng con đường diễn ra lễ hội, bảng danh sách ghi địa chỉ là Broad Avenue[cite: 21].",
  181: "💡 <b>Đáp án (C):</b> Doanh nghiệp nổi tiếng lâu nay nhờ các gói dịch vụ dọn dẹp nhà cửa định kỳ hàng tuần, hàng tháng[cite: 21].",
  182: "💡 <b>Đáp án (A):</b> Cả ba gói dịch vụ chuyên sâu đều có người giám sát đi kèm phụ trách nhóm (Supervised work teams)[cite: 21].",
  183: "💡 <b>Đáp án (D):</b> Công ty vừa đăng tải các video hướng dẫn mẹo vặt dọn dẹp nhà cửa hữu ích trong 2 tháng qua[cite: 21].",
  184: "💡 <b>Đáp án (C):</b> Ông Singh sử dụng gói dọn nhà một lần, gói này do một nhóm 3 người và một giám sát viên thực hiện[cite: 21].",
  185: "💡 <b>Đáp án (B):</b> Từ 'just' trong cụm 'at just the right time' (vừa đúng thời điểm) đồng nghĩa với **exactly**[cite: 21].",
  186: "💡 <b>Đáp án (B):</b> Trang web giải thích các tiêu chuẩn và chính sách nhận sách cũ đổi lấy điểm tích lũy mua hàng[cite: 21].",
  187: "💡 <b>Đáp án (A):</b> Trang web nhắc tới sách dạy nấu ăn của các đầu bếp nổi tiếng như Ian Wu ('celebrity chef') -> Ông ấy là người nổi tiếng[cite: 21].",
  188: "💡 <b>Đáp án (C):</b> Cửa hàng ưu tiên sách cổ và sách xuất bản lần đầu, nên 2 cuốn tiểu thuyết kinh điển xuất bản lần đầu của cụ cố để lại sẽ được nhận[cite: 21].",
  189: "💡 <b>Đáp án (D):</b> Ông Townsend cho biết 3 cuốn sách nấu ăn chứa công thức từ 'members of a charity I run' -> Ông điều hành một tổ chức từ thiện[cite: 21].",
  190: "💡 <b>Đáp án (B):</b> Cửa hàng đóng cửa thứ Hai, thứ Ba. Cuối tuần chỉ mở cửa từ 10h sáng (thứ Bảy) và trưa (Chủ nhật), trong khi ông chỉ rảnh trước 9h sáng cuối tuần. Do đó ông chỉ có thể ghé vào thứ Tư[cite: 21].",
  191: "💡 <b>Đáp án (C):</b> Giám đốc nhân sự gửi email để lên kế hoạch đào tạo thực tế và tiếp nhận nhân viên mới David Rein[cite: 21].",
  192: "💡 <b>Đáp án (D):</b> Max Aurinen nhận chỉ đạo chuẩn bị hồ sơ thủ tục và sắp xếp lịch làm việc cho nhân sự mới -> Trợ lý hành chính/nhân sự[cite: 21].",
  193: "💡 <b>Đáp án (C):</b> David Rein làm phó giám sát bộ phận Large Appliance, danh bạ xác nhận Giám đốc bộ phận này là Latisha Lake[cite: 21].",
  194: "💡 <b>Đáp án (A):</b> Danh bạ liệt kê văn phòng của các giám đốc ở nhiều tòa nhà khác nhau (Ardmore, Winston West, Winston East, Meisner) -> Có nhiều tòa nhà[cite: 21].",
  195: "💡 <b>Đáp án (B):</b> Lịch trình chính thức ngày 9/5 ghi David Rein sẽ đi cùng Amos Hillman, chứng tỏ ông Hillman đã kịp trở về sau chuyến đi Thái Lan[cite: 21].",
  196: "💡 <b>Đáp án (A):</b> Bài báo nêu video drone quay từ trên cao phục vụ nhiều mục đích kinh doanh như tiếp thị, báo cáo tiến độ, đào tạo...[cite: 21].",
  197: "💡 <b>Đáp án (C):</b> Quy định RFA yêu cầu phi công lái drone phải hoàn thành bài phỏng vấn với giám sát viên sát hạch bay[cite: 21].",
  198: "💡 <b>Đáp án (A):</b> Khách hàng Lunsklip Construction yêu cầu video quay toàn cảnh tuyến cao tốc để trình chiếu cho các nhà đầu tư thấy tiến độ dự án[cite: 21].",
  199: "💡 <b>Đáp án (C):</b> Bà Rowley là phi công lái drone thương mại, theo quy định của RFA thì bà bắt buộc phải đăng ký thiết bị bay với cơ quan hàng không[cite: 21].",
  200: "💡 <b>Đáp án (B):</b> Phiếu yêu cầu ghi rõ không cần kỹ xảo hay chỉnh sửa thêm, bài báo nêu công ty chỉ tính phụ phí theo giờ nếu yêu cầu chỉnh sửa phức tạp -> Không phải trả thêm phụ phí giờ[cite: 21]."
};
